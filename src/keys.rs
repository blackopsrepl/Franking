...
fn resolve_message_view(key: KeyEvent) -> Action {
    match key.code {
        ...
        KeyCode::Char('1') => Action::MessageModeAuto,
        KeyCode::Char('2') => Action::MessageModePlain,
        KeyCode::Char('3') => Action::MessageModeHtml,
        KeyCode::Char('o') => Action::OpenHtmlExternally,
        KeyCode::Char('?') => Action::ToggleHelp,
        KeyCode::Char('g') => Action::JumpTop,
        KeyCode::Char('G') => Action::JumpBottom,
        _ => Action::None,
