...
impl AccountField {
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            AccountField::ImapHost => "IMAP host",
            AccountField::ImapPort => "IMAP port",
            AccountField::ImapSecurity => "IMAP security",
            AccountField::SmtpHost => "SMTP host",
            AccountField::SmtpPort => "SMTP port",
            AccountField::SmtpSecurity => "SMTP security",
            AccountField::SieveHost => "Sieve host",
            AccountField::SievePort => "Sieve port",
            AccountField::Auth => "Auth",
            AccountField::ClientId => "Client ID",
            AccountField::ClientSecret => "Client secret",
