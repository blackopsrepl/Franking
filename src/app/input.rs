...
impl App {
    ...
    pub fn handle_key(&mut self, key: KeyEvent) {
        ...
        match action {
            ...
            Action::SettingsToggleNotifications => self.settings_toggle(),
            Action::SettingsNext => self.settings_move(1),
            Action::SettingsPrev => self.settings_move(-1),
            ...
            Action::OpenInviteReply => self.open_invite_reply(),
            Action::InviteRespond(partstat) => self.respond_invitation(partstat),
            Action::InviteCancel => self.cancel_invite_reply(),
